...
const BoardDirectors = () => {
    return (
        ...
        <div className="w-[1170px] mx-auto">
          <p className="text-[32px] font-semibold text-center "> Board of directors</p>
          <div className="mt-14 grid grid-cols-1 lg:grid-cols-3 gap-20">
            ...
            <div className="w-[366px]">
              ...
              {/* 2 number card */}
            <div className="w-[366px]">
              <img className="h-[366px]" src={donblair} alt="" />
              <p className="text-[20px] font-semibold mt-3 mb-4">Don Blair, Former CFO Nike
</p>
              <p className="text-[16px]">
            ...
            <div className="w-[366px]">
              <img className="h-[366px]" src={lisacampbell} alt="" />
              <p className="text-[20px] font-semibold mt-3 mb-4">Lisa Campbell, CMO OneTrust
</p>
              <p className="text-[16px]">
            ...
            <div className="w-[366px]">
              <img className="h-[366px]" src={pauljacobs} alt="" />
              <p className="text-[20px] font-semibold mt-3 mb-4">Paul Jacobs, CEO Globalstar, Inc. and VIREWIRX, Inc., and Former CEO Qualcomm
            ...
            <div className="w-[366px]">
              <img className="h-[366px]" src={saramathew} alt="" />
              <p className="text-[20px] font-semibold mt-3 mb-4">Sara Mathew, Former Chairman and CEO of Dun & Bradstreet
  </p>
              <p className="text-[16px]">
            ...
            <div className="w-[366px]">
              <img className="h-[366px]" src={abhayabout} alt="" />
              <p className="text-[20px] font-semibold mt-3 mb-4">Abhay Parasnis, CEO Typeface.ai
              ...
              Abhay brings over two decades of experience scaling new businesses and innovative technology platforms. Previously, as CPO & CTO at Adobe, he was responsible for leading product strategy, technology vision, and engineering for Adobe’s diverse cloud portfolio. Abhay also held leadership roles at major technology companies including Microsoft, Oracle, and IBM.
               ...
               <div className="w-[366px]">
              <img className="h-[366px]" src={karenpeacock} alt="" />
              <p className="text-[20px] font-semibold mt-3 mb-4">Karen Peacock, Former CEO Intercom
  </p>
              <p className="text-[16px]">
              Karen brings years of experience growing teams and scaling businesses. In her prior role as CEO of Intercom, she led the business messaging app’s company and product strategy. She also previously served as Intuit’s SVP of Small Business, where she oversaw all of the division’s products and helped grow its annual revenue.
               ...
               <div className="w-[366px]">
              <img className="h-[366px]" src={michaelseibel} alt="" />
              <p className="text-[20px] font-semibold mt-3 mb-4">Michael Seibel, Group Partner at Y Combinator
              ...
              Michael is a skilled entrepreneur, investor, and advisor to companies across industries. He’s now Group Partner of Y Combinator. Previously, he was Managing Partner of YC Early Stage, co-founder and CEO of Justin.tv, which later became Twitch Interactive, and co-founder of Socialcam.
               ...
               <div className="w-[366px]">
              <img className="h-[366px]" src={andrewmoore} alt="" />
              <p className="text-[20px] font-semibold mt-3 mb-4">Dr. Andrew Moore, Founder and CEO of Lovelace AI
  </p>
              <p className="text-[16px]">
