  ...
  return (
    <div className="text-[#F7F5F2]">
      <div className="lg:flex justify-between ">
        <div className="lg:w-1/2  bg-[#1E1919] ">
          <div className="py-12 px-16 h-full">
            <p className="text-[14px] font-semibold">New Release</p>{" "}
            <p className="text-[20px] md:text-[40px] lg:text-[40px] my-4 w-[250px] md:w-[500px] lg:w-[500px] lg:leading-[45px] font-space_grotesk font-bold">
              Working Smarter — A podcast about AI and modern work
            </p>
            <p className="text-[16px] font-medium w-[250px] md:w-[500px] lg:w-[500px]">
            ...
            <p className="text-[16px] my-4 font-medium w-[250px] md:w-[500px] lg:w-[500px]">
            ...
            <div className="text-center  mt-5 ">
              <button className="hover:bg-[#44474d]  border-2 text-[16px] font-semibold px-7  py-3  md:py-5  lg:py-5 text-center flex justify-center items-center gap-7 ">
