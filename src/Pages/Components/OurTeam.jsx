...
const OurTeam = () => {
  return (
    <div className="bg-[#1E1919] text-white py-5 md:py-16 lg:py-16">
      <div className="w-[250px] md:w-[1170px]  lg:w-[1170px]  mx-auto">
        <p className="text-[22px] md:text-[32px] lg:text-[32px] text-center "> Our Team</p>
        <div className=" mt-3  md:mt-14  lg:mt-14 grid grid-cols-1 lg:grid-cols-3 gap-10 md:gap-20 lg:gap-20">
          ...
          <div className="w-[200px] md:w-[366px] lg:w-[366px] mx-auto md:mx-0 lg:mx-0">
            ...
            {/* 2 number card */}
          <div className="w-[200px] md:w-[366px] lg:w-[366px] mx-auto md:mx-0 lg:mx-0">
            <img className="h-[200px] md:h-[366px] lg:h-[366px]" src={samanasheer} alt="" />
            <p className="text-[15px] md:text-[20px] lg:text-[20px] font-semibold mt-3 mb-4">Saman Asheer, Chief Communications Officer</p>
            <p className="text-[16px]">
          ...
          <div className="w-[200px] md:w-[366px] lg:w-[366px] mx-auto md:mx-0 lg:mx-0">
            <img className="h-[200px] md:h-[366px] lg:h-[366px]" src={melaniecollins} alt="" />
            <p className="text-[15px] md:text-[20px] lg:text-[20px] font-semibold mt-3 mb-4">Melanie Rosenwasser, Chief People Officer</p>
            <p className="text-[16px]">
          ...
          <div className="w-[200px] md:w-[366px] lg:w-[366px] mx-auto md:mx-0 lg:mx-0">
            <img className="h-[200px] md:h-[366px] lg:h-[366px]" src={timregan} alt="" />
            <p className="text-[15px] md:text-[20px] lg:text-[20px] font-semibold mt-3 mb-4">Tim Regan, Chief Financial Officer
</p>
            <p className="text-[16px]">
          ...
          <div className="w-[200px] md:w-[366px] lg:w-[366px] mx-auto md:mx-0 lg:mx-0">
            <img className="h-[200px] md:h-[366px] lg:h-[366px]" src={bartvolkmer} alt="" />
            <p className="text-[15px] md:text-[20px] lg:text-[20px] font-semibold mt-3 mb-4">Bart Volkmer, Chief Legal Officer
</p>
            <p className="text-[16px]">
          ...
          <div className="w-[200px] md:w-[366px] lg:w-[366px] mx-auto md:mx-0 lg:mx-0">
            <img className="h-[200px] md:h-[366px] lg:h-[366px]" src={EricCox} alt="" />
            <p className="text-[15px] md:text-[20px] lg:text-[20px] font-semibold mt-3 mb-4">Eric Cox, Chief Customer Officer
</p>
            <p className="text-[16px]">
